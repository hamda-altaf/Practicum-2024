...
model_interaction <- svyglm(
  Depression ~ Endometriosis * AgeGroup + Endometriosis * PIR_Category + 
...
model_age_20_29 <- svyglm(Depression ~ Endometriosis, design = survey_design_age_20_29, family = quasibinomial())
...
model_age_30_40 <- svyglm(Depression ~ Endometriosis, design = survey_design_age_30_40, family = quasibinomial())
...
model_age_41_54 <- svyglm(Depression ~ Endometriosis, design = survey_design_age_41_54, family = quasibinomial())
